    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="section-padding">
        <div className="container-custom space-y-16">
          {headerUseCases.map((useCase, index) => (
      ...
      <section className="section-padding bg-brand-aqua">
        <div className="container-custom text-center space-y-12">
            ...
            {customerIcons.map((item, index) => (
              <div key={index} className="space-y-4">
                <button
                  ...
                  className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto hover:bg-white/30 transition-colors duration-300 cursor-pointer group"
                >
          ...
          {activeIcon !== null && (
            <div className="mt-8 bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-3xl mx-auto animate-fade-in">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
                  {createElement(customerIcons[activeIcon].icon, { className: "w-6 h-6 text-white" })}
                </div>
      ...
      {/* Test Ride CTA */}
      <section className="section-padding bg-brand-dark-purple">
        <div className="container-custom text-center space-y-8">
          ...
          <Button 
            className="btn-secondary-outline text-white border-white hover:bg-white hover:text-brand-dark-purple"
