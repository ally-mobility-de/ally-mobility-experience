                ...
                <div className="max-w-2xl mx-auto text-center space-y-8">
                  ...
                  <div className="flex justify-center items-center gap-8">
                    <div className="flex items-center gap-3">
                      <div className="w-6 h-6 text-brand-aqua">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 7.89a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                      </div>
                      <span className="text-muted-foreground">info@ally-mobility.de</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-muted-foreground">+49 (0) 30 123 456 78</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center">
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 text-brand-aqua mt-1">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="text-muted-foreground text-left">
                        <div>ally-mobility</div>
                        <div>Haselbacherstraße 18a</div>
                        <div>04617 Treben, DE</div>
                      </div>
                    </div>
                  </div>
                </div>
