...
const ContactForm = () => {
  ...
  {/* Icons centered in one row (stack on mobile); text lines directly underneath */}
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center place-items-center">
    ...
    <div>
      ...
      <a href="mailto:contact@ally-mobility.com" className="block mt-3 text-foreground hover:underline">
    ...
    <div>
      <div className="w-8 h-8 text-brand-aqua mx-auto">
        <svg aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h2.28a2 2 0 011.94 1.42l1.02 3.4a2 2 0 01-.5 2.02L9.1 11.78a16 16 0 006.12 6.12l1.96-1.64a2 2 0 012.02-.5l3.4 1.02A2 2 0 0123 18.72V21a2 2 0 01-2 2h-1C9.163 23 1 14.837 1 5V4a2 2 0 012-2" />
        </svg>
      </div>
      <a href="tel:+490000000000" className="block mt-3 text-foreground hover:underline">
        +49 000 0000000
      </a>
    </div>
