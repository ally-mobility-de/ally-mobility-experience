        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex items-center gap-4">
              <a 
                href="#" 
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-brand-aqua transition-colors duration-300"
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              <button 
                ...
                className="block text-white/80 hover:text-brand-aqua transition-colors duration-300"
              >
                Overview
              </button>
              <button 
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              ...
              <a 
                href="#dealer"
                className="block text-brand-aqua font-medium hover:text-white transition-colors duration-300"
              >
                Become a Dealer
              </a>
              <a 
