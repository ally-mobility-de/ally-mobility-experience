...
const Community = () => {
  ...
  const articles: ArticleCard[] = [
    ...
    {
      id: '6',
      title: 'Sustainable Logistics Revolution',
      excerpt: 'How cargo bikes are transforming last-mile delivery with zero emissions and maximum efficiency.',
      source: 'Green Transport News',
      platform: 'News',
      image: '/lovable-uploads/93f64d63-22a9-46a0-8efa-e70fbcfcbf49.png',
      link: '#'
    }
                  ...
                  <div key={slideIndex} className="w-full flex-shrink-0">
                    <div className="flex gap-6 px-4 items-stretch">
                      {articles
                        ...
                        .map((article, index) => {
                          // Alternate sizing: first card bigger on even slides, second card bigger on odd slides
                          const isFirstCard = index === 0;
                          const isBigCard = slideIndex % 2 === 0 ? isFirstCard : !isFirstCard;
